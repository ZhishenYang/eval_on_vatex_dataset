...
class AttentiveMNMTFeatures(NMT):
    ...
    def setup(self, is_train=True):
        ...
        self.dec = ConditionalMMDecoder(
            ...
            emb_maxnorm=self.opts.model['emb_maxnorm'],
            emb_gradscale=self.opts.model['emb_gradscale'],
            use_feat_pe=self.opts.model['use_aux_pe'],
            feat_max_len=self.opts.model['aux_pe_max_len'],)
    ...
    def encode(self, batch, **kwargs):
        ...
        feats, feats_mask = batch[self.feat_name], None
        ...
        return {
            self.feat_name: (feats, feats_mask),
